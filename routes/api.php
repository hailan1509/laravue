...
Route::namespace('Api')->group(function() {
    ...
    Route::get('/phong/list','PhongController@index' );
    Route::post('/phong/addOrEdit','PhongController@store' );
    Route::post('/phong/delete','PhongController@delete' );
    Route::get('/DichVu/list','DichVuController@index' );
    Route::post('/DichVu/addOrEdit','DichVuController@store' );
    Route::post('/DichVu/delete','DichVuController@delete' );
    Route::get('/HopDong/list','HopDongController@index' );
